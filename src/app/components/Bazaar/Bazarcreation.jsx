...
//                                     <span className="text-[#50604a]">✓</span>
//                                     {pkg.type} bazaar type
//                                   </li>
//                                   <li className="flex items-center gap-1.5">
//                                     <span className="text-[#50604a]">✓</span>
//                                     Up to {pkg.maxBrandCapacity} brands
//                                   </li>
//                                   <li className="flex items-center gap-1.5">
//                                     <span className={pkg.topSearch ? "text-[#50604a]" : "text-gray-300"}>
//                                       {pkg.topSearch ? "✓" : "✕"}
//                                     </span>
//                                     Top search placement
//                                   </li>
//                                   <li className="flex items-center gap-1.5">
//                                     <span className={pkg.aiAssistant ? "text-[#50604a]" : "text-gray-300"}>
//                                       {pkg.aiAssistant ? "✓" : "✕"}
//                                     </span>
//                                     AI assistant
//                                   </li>
...
const PACKAGES = [
  { id: "STARTER", name: "Starter", type: "ONLINE", maxBrandCapacity: 20, topSearch: false, aiAssistant: false, price: 2000 },
  { id: "BUSINESS", name: "Business", type: "HYBRID", maxBrandCapacity: 50, topSearch: false, aiAssistant: true, price: 4000 },
  { id: "PREMIUM", name: "Premium", type: "HYBRID", maxBrandCapacity: 100, topSearch: true, aiAssistant: true, price: 6000 },
];
