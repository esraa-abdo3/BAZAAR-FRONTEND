...
export default function BrandSidebar({ activePage, setActivePage }) {
  ...
  return (
    <aside className="w-[140px] min-h-screen bg-white border-r border-stone-200 flex flex-col py-6 shrink-0">
      ...
      <div className="px-4 mb-6">
        <p className="font-semibold text-stone-800 text-sm leading-tight">Brand Name</p>
        <p className="text-[10px] text-stone-400 uppercase tracking-widest mt-0.5">Global Marketplace</p>
      </div>
