...
// import { getAdminBazaars, getAdminOneBazaar, updateAdminBazaar } from "@/app/services/adminService";
...
//       setUpdating(true);
//       setError(null);
//       await updateAdminBazaar(editingBazaar._id, {
...
//         <div>
//           <h2 className="text-sm font-semibold text-gray-800">Bazaars Management</h2>
...
//                 setPage(1);
//               }}
//               className="appearance-none pl-8 pr-8 py-2 border border-gray-100 rounded-lg text-xs focus:outline-none focus:border-indigo-400 bg-white text-gray-600 font-medium"
//             >
...
//             />
//             <p className="text-xs text-gray-400">Loading bazaars catalog...</p>
//           </div>
...
//               </svg>
//             </span>
//             <p className="text-xs font-semibold text-gray-700">No Bazaars Found</p>
//             <p className="text-[10px] text-gray-400 mt-1">Try adapting your search or filter.</p>
//           </div>
//         ) : (
...
//                         )}
//                         <div>
//                           <p className="font-semibold text-gray-800">{b.bazaarName}</p>
//                           <span className="text-[10px] text-indigo-600 bg-gray-100 px-1.5 py-0.5 rounded font-medium">
...
//                     {/* Schedule */}
//                     <td className="px-6 py-4">
//                       <p className="text-gray-700 flex items-center gap-1.5 text-[11px]">
...
//                           className="w-7 h-7 flex items-center justify-center rounded bg-gray-50 border border-gray-100 text-gray-600 hover:bg-gray-100 transition-colors"
//                           title="Edit Bazaar"
//                         >
//                           <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
//               )}
//               <div>
//                 <h3 className="font-semibold text-gray-800 text-sm">{detailBazaar.bazaarName}</h3>
//                 <p className="text-[10px] text-gray-400 uppercase tracking-widest font-semibold mt-0.5">{detailBazaar.type} Bazaar</p>
//               </div>
//             </div>
...
//                   <span className="text-[9px] text-gray-400 block font-semibold uppercase tracking-wider">Status</span>
//                   <span className="font-bold text-gray-700">{detailBazaar.status}</span>
//                 </div>
//                 <div className="p-2 border border-gray-100 rounded-lg bg-gray-50/50">
//                   <span className="text-[9px] text-gray-400 block font-semibold uppercase tracking-wider">Max Capacity</span>
//                   <span className="font-bold text-gray-700">{detailBazaar.maxBrandCapacity} brands</span>
//                 </div>
//                 <div className="p-2 border border-gray-100 rounded-lg bg-gray-50/50">
//                   <span className="text-[9px] text-gray-400 block font-semibold uppercase tracking-wider">Pricing (Offline)</span>
//                   <span className="font-bold text-indigo-600">{detailBazaar.priceOffline} EGP</span>
//                 </div>
//                 <div className="p-2 border border-gray-100 rounded-lg bg-gray-50/50">
//                   <span className="text-[9px] text-gray-400 block font-semibold uppercase tracking-wider">Pricing (Online)</span>
//                   <span className="font-bold text-indigo-600">{detailBazaar.priceOnline} EGP</span>
//                 </div>
//               </div>
//               <div className="mt-2 flex flex-col gap-1.5 text-[11px] text-gray-600 border-t border-gray-100 pt-2">
...
//           <div className="bg-white rounded-xl border border-gray-100 shadow-xl p-6 w-full max-w-lg flex flex-col gap-4 relative my-8">
//             <button
//               onClick={() => setEditingBazaar(null)}
//               className="absolute top-4 right-4 text-gray-400 hover:text-gray-600"
//             >
//               <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
//                 <line x1="18" y1="6" x2="6" y2="18" />
...
//               </svg>
//             </button>
//             <h3 className="font-semibold text-gray-800 text-sm">Edit Bazaar settings</h3>

//             <form onSubmit={handleSave} className="flex flex-col gap-4">
//               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//                 {/* Bazaar Name */}
//                 <div className="flex flex-col gap-1">
//                   <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Bazaar Name</label>
//                   <input
//                     type="text"
//                     required
//                     value={editingBazaar.bazaarName}
//                     onChange={(e) => setEditingBazaar({ ...editingBazaar, bazaarName: e.target.value })}
//                     className="px-3 py-2 border border-gray-100 rounded-lg text-xs focus:outline-none focus:border-indigo-400 text-gray-800 bg-white"
//                   />
//                 </div>
...
//                     className="px-3 py-2 border border-gray-100 rounded-lg text-xs focus:outline-none focus:border-indigo-400 bg-white text-gray-800"
//                   >
//                     {STATUSES.map((st) => (
//                       <option key={st} value={st}>
//                         {st}
...
//                   rows={2}
//                   className="px-3 py-2 border border-gray-100 rounded-lg text-xs focus:outline-none focus:border-indigo-400 text-gray-800 bg-white resize-none"
//                 />
//               </div>
...
//                 <div className="flex flex-col gap-1">
//                   <label className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider">Price Offline</label>
//                   <input
//                     type="number"
//                     value={editingBazaar.priceOffline}
//                     onChange={(e) => setEditingBazaar({ ...editingBazaar, priceOffline: e.target.value })}
//                     className="px-2 py-1.5 border border-gray-100 rounded text-xs focus:outline-none focus:border-indigo-400 text-gray-800 bg-white"
//                   />
//                 </div>
//                 <div className="flex flex-col gap-1">
//                   <label className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider">Price Online</label>
//                   <input
//                     type="number"
...
//                 </div>
//                 <div className="flex flex-col gap-1">
//                   <label className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider">Price Hybrid</label>
//                   <input
//                     type="number"
...
//                 {/* Max Brand Capacity */}
//                 <div className="flex flex-col gap-1">
//                   <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Max Brand Capacity</label>
//                   <input
//                     type="number"
...
//                 {/* Address */}
//                 <div className="flex flex-col gap-1">
//                   <label className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Address / Venue</label>
//                   <input
//                     type="text"
...
//                 <label className="flex items-center gap-2 text-xs text-gray-600 font-semibold select-none cursor-pointer">
//                   <input
//                     type="checkbox"
//                     checked={editingBazaar.isPaid}
//                     onChange={(e) => setEditingBazaar({ ...editingBazaar, isPaid: e.target.checked })}
//                     className="w-4 h-4 rounded text-indigo-600 border-stone-300 focus:ring-[#4f46e5]/30 cursor-pointer"
//                   />
//                   Bazaar Paid status
//                 </label>
...
//                   onClick={() => setEditingBazaar(null)}
//                   disabled={updating}
//                   className="px-4 py-2 border border-gray-100 text-xs font-semibold rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 cursor-pointer text-gray-700"
//                 >
//                   Cancel
//                 </button>
//                 <button
//                   type="submit"
//                   disabled={updating}
//                   className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-lg transition-colors flex items-center gap-1.5 disabled:opacity-60 cursor-pointer"
//                 >
//                   {updating ? (
//                     <>
//                       <div
