...
//       if (savedPromo) {
//         setFormData((prev) => ({ ...prev, promoCode: savedPromo }));
//       }
//     }
//   }, []);
...
//     const match = formData.promoCode.toUpperCase().match(/^BAZARY(5|10|15|20|25|30|50)OFF/);
//     if (match) {
...
//   const discountPercent = getPromoDiscount();
//   const discountAmount = (cart?.totalAmount * discountPercent) / 100;
//   const finalTotalAmount = (cart?.totalAmount || 0) - discountAmount;
...
//       const stock = item.productId?.quantity ?? 999;
//       return stock <= 0 || item.quantity > stock;
//     });

//     if (outOfStockItems.length > 0) {
//       const names = outOfStockItems.map(i => i.productId?.name || "a product").join(", ");
//       setError(`Please adjust or remove the following item(s) before placing your order: ${names}.`);
//       return;
//     }
...
//         setCartSnapshot({ totalAmount: finalTotalAmount });
//         setClientSecret(secret);
//         return;
//       }
...
//                 {/* Promo Code Input */}
//                 <div style={{ borderTop: "1px solid #f3f4f6", padding: "16px 0", marginBottom: "8px" }}>
//                   <label style={{ ...labelStyle, marginBottom: "8px" }}>Have a promo code?</label>
...
//                       onChange={handleChange}
//                       placeholder="مثال: BAZARY15OFF123456"
//                       style={{
//                         ...inputStyle,
//                         flex: 1,
...
//                       <button
//                         type="button"
//                         onClick={() => setFormData(prev => ({ ...prev, promoCode: "" }))}
//                         style={{
//                           padding: "0 12px",
//                           background: "#f3f4f6",
//                           border: "none",
...
//                       <span style={{ fontSize: "14px" }}>Discount ({discountPercent}%)</span>
//                       <span style={{ fontWeight: 600 }}>-{discountAmount} EGP</span>
//                     </div>
//                   )}
//                   <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "16px" }}>
//                     <span style={{ color: "#6b7280", fontSize: "14px" }}>Shipping</span>
...
//                       <path d="M9 12l2 2 4-4M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
//                     </svg>
//                     Place Order · {finalTotalAmount} EGP
//                   </>
//                 )}
//               </button>
//             </div>
